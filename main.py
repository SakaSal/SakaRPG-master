...
def fight(attacker, defender):
    ...
    print(f"{attacker.name}'hp is {attacker.atribs["hp"]}, {defender.name}'s hp is {defender.atribs["hp"]}")
    in_fight = True
    ...
    while in_fight:
        ...
        if defender_strikes > 0:    
            print(f"[DEFENDER] HP: {defender.atribs["hp"]}\nstrikes remaining: {defender_strikes}\n[ATTACKER] HP: {attacker.atribs["hp"]}\nstrikes remaining: {attacker_strikes}")
